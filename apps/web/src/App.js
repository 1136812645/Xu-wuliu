...
function buildSettlementAdjustmentCode(rule) {
...
export function App() {
        ...
        async function load() {
            ...
            try {
                ...
                if (!cancelled) {
                    ...
                    setPricingRuleCreateDraft(buildNextPricingRuleDraft(pricingData.items, {
    ...
    const warningView = useMemo(() => {
        ...
        const vehicleByDriverId = new Map(bootstrap.references.vehicles
